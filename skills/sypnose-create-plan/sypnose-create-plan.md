...
AL TERMINAR (OBLIGATORIO — INCLUIR EN CADA PLAN):
kb_save key=resultado-[nombre]-[fecha] category=notification project=[proyecto] value="
DONE: [que ejecutaste]
COMMITS: [hashes]
VERIFICADO: [outputs reales copiados]
DESCUBRIMIENTOS: [bugs, mejoras, riesgos encontrados]
INQUIETUDES: [que te preocupa]
SUGERENCIAS: [que harias como proximo paso]
"
Preguntate mejoras. Reportar. PARAR.
